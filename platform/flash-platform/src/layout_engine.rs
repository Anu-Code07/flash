...
fn intrinsic_width(kind: NodeKind) -> f32 {
    match kind.name() {
        ...
        "Divider" => 280.0,
        "ProgressBar" => 280.0,
        "Switch" | "Checkbox" => 51.0,
        "Loading" => 40.0,
        "AppBar" | "TabBar" | "Toolbar" => 390.0,
        "Modal" | "Sheet" | "BottomSheet" => 390.0,
        "SectionList" | "List" => 390.0,
        _ => 100.0,
    }
}
...
fn intrinsic_height(kind: NodeKind) -> f32 {
    match kind.name() {
        ...
        "Divider" => 1.0,
        "ProgressBar" => 4.0,
        "Switch" | "Checkbox" => 31.0,
        "Loading" => 40.0,
        "AppBar" => 56.0,
        "TabBar" => 49.0,
        "Modal" | "Sheet" | "BottomSheet" => 320.0,
        "SectionList" | "List" => 200.0,
        _ => 40.0,
    }
}
